...
@section('content')
    <div class="card">
        ...
        <div class="row my-4 mx-3">
            ...
            <p>Setiap elemen pada kolom di matriks perbandingan kriteria dijumlahkan terlebih dahulu:</p>
        ...
        <div class="row my-4 mx-3">
            <h2>Tabel Normalisasi Perbandingan Kriteria</h2>
        ...
        <div class="row my-4 mx-3">
            ...
            <p>Bobot kriteria dihitung dengan mencari rata-rata dari setiap baris di matriks normalisasi:</p>
            ...
            <table class="table table-bordered table-hover text-center">
                ...
                <tr>
                    ...
                    @endforeach
                    <th>{{ collect($bobotKriteria)->sum() }}</th>
                </tr>
            </table>
        </div>
        <div class="row my-4 mx-3">
            <h2>Tabel Nilai Eigen</h2>
            <p>Matriks nilai eigen diperoleh dengan mengalikan matriks perbandingan awal dengan vektor bobot:
            </p>
        ...
        <div class="row my-4 mx-3">
            ...
            <p class="formula">\[ \text{CI} = \frac{\lambda_{\text{max}} - n}{n -
                1}=\frac{\{{ collect($eigenValue)->sum() }} - {{ $criteria->count() }}}{\{{ $criteria->count() }} - 1} \]
            </p>
            <h4>CI = {{ $ci }}</h4>
            <br>
            <h4>RI = {{ $irc }}</h4>
            <p>Consistency Ratio (CR) dihitung dengan membandingkan CI dengan Random Index (RI):</p>
            <p class="formula">\[ \text{CR} = \frac{\text{CI}}{\text{RI}} \]</p>
            <br>
            <h4>CR = {{ $cr }} </h4>
            <p>Jika nilai CR < 0.1 (10%), maka matriks tersebut konsisten, dan bobot dapat digunakan untuk keputusan.</p>
        </div>
        <div class="row my-4 mx-3">
