    ...
    <div class="offcanvas-md offcanvas-end bg-body-tertiary" tabindex="-1" id="sidebarMenu"
        ...
        <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto">
            <ul class="nav flex-column">
                ...
                <li class="nav-item {{ Request::is('responden*') ? 'bg-secondary' : '' }}">
                    <a class="nav-link d-flex align-items-center  {{ Request::is('responden*') ? 'text-light' : '' }} gap-2 fs-4"
                ...
                <li class="nav-item {{ Request::routeIs('perhitungan.index') ? 'bg-secondary' : '' }}">
                    <a class="nav-link d-flex align-items-center {{ Request::routeIs('perhitungan.index') ? 'text-light' : '' }} gap-2"
